...
function notifBell() {
    return {
        ...
        async charger() {
            try {
                const res  = await fetch('<?php echo e(route("notifications.dernieres")); ?>', {
        ...
        async toutLire() {
            await fetch('<?php echo e(route("notifications.tout-lire")); ?>', {
                method: 'POST',
                headers: {
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\biocolis_nextgent\resources\views/components/notification-bell.blade.php ENDPATH**/ ?>