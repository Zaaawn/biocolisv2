...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['annonce']));
...
foreach (array_filter((['annonce']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<div class="bg-white rounded-2xl border border-gray-100 overflow-hidden hover:shadow-md hover:-translate-y-0.5 transition-all duration-200 group">
    ...
    <a href="<?php echo e(route('annonces.show', $annonce->slug)); ?>" class="block relative aspect-[4/3] overflow-hidden bg-gray-100">
        <img
            src="<?php echo e($annonce->premiere_photo); ?>"
            alt="<?php echo e($annonce->titre); ?>"
        ...
        <div class="absolute top-2 left-2 flex flex-wrap gap-1">
            ...
            <span class="bg-white/90 backdrop-blur text-gray-700 text-xs font-semibold px-2 py-0.5 rounded-full">
                <?php echo e(match($annonce->label) {
                    'bio' => '🍃 Bio',
                    'local' => '📍 Local',
                    'raisonne' => '♻️ Raisonné',
        ...
        <?php if(auth()->guard()->check()): ?>
            <?php if(auth()->id() !== $annonce->user_id): ?>
                <button
                    onclick="toggleLike(event, <?php echo e($annonce->id); ?>, this)"
    ...
    <a href="<?php echo e(route('annonces.show', $annonce->slug)); ?>" class="block p-4">
        
        <div class="flex items-center gap-2 mb-2">
            <img src="<?php echo e($annonce->user->photo_profil_url); ?>"
                 alt="<?php echo e($annonce->user->nom_complet); ?>"
                 class="w-5 h-5 rounded-full object-cover">
            <span class="text-xs text-gray-500"><?php echo e($annonce->user->prenom); ?></span>
        ...
        <p class="text-xs text-gray-400 mb-3 flex items-center gap-1">
            ...
            <?php echo e($annonce->ville ?? $annonce->localisation); ?>
        ...
        <div class="flex items-center justify-between">
            <div>
                <span class="text-lg font-bold text-green-600"><?php echo e(number_format($annonce->prix, 2)); ?>€</span>
                <span class="text-xs text-gray-400">/ <?php echo e($annonce->unite_prix); ?></span>
            </div>
        ...
        <?php if($annonce->note_moyenne > 0): ?>
            <div class="flex items-center gap-1 mt-2">
                <span class="text-yellow-400 text-xs">★</span>
                <span class="text-xs text-gray-600 font-medium"><?php echo e(number_format($annonce->note_moyenne, 1)); ?></span>
                <span class="text-xs text-gray-400">(<?php echo e($annonce->nb_commandes); ?>)</span>
            </div>
        <?php endif; ?>
    </a>
</div>
...
<?php /**PATH C:\laragon\www\biocolis_nextgent\resources\views/components/annonce-card.blade.php ENDPATH**/ ?>